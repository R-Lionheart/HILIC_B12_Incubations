...
Outputs: Osmolytes file, edited for input into the rest of the script, titled Osmolytes_dited.csv.
...
ANOSIM_IndicSpecies.R
ANOVA_all (mostly useless. needs work.)
anova b12
anova dsw
FourCompound_Ratios.R
Heatmaps.R
Heatmps_with_Clustering.R
kmeans_PAM.R
Ratios.R
Raw_Plots.R
Univariate_Stats.R